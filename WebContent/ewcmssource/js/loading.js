...
document
		.write('<div id="loading_mask_msg" style="position: absolute; cursor1: wait; width: 200px; height: 16px;top:'
				...
				+ 'px;  padding: 12px 5px 10px 30px; background: #fff url(/ewcms/ewcmssource/easyui/themes/default/images/pagination_loading.gif) no-repeat scroll 5px 10px; border: 2px solid #6593CF; color: #222; display: block;"><font size="9">页面正在加载，请稍候。。。</font></div>');
