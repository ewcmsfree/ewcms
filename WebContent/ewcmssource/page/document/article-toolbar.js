...
ArticleToolbar.prototype.show = function(){
	this.Html = [];
	this.Html.push("<div id='DivToolbar' style='display:inline-block;display:-moz-inline-box; -moz-box-align:stretch;*zoom: 1;*display: inline;vertical-align:middle; overflow:hidden;display:block;'>");
...
ArticleToolbar.prototype.addFontColor = function(){
	...
	this.Html.push("<td style='height:17px;'><img src='../../ewcmssource/image/article/toolbar/spacer.gif' style='background-position: 0px -704px; background-image: url(../../ewcmssource/image/article/toolbar/fck_strip.gif);overflow: hidden;width: 14px;height: 14px;margin: 0px;'></td>");
	this.Html.push("<td style='height:17px;'><img height='3' width='5' src='../../ewcmssource/image/article/toolbar/toolbar.buttonarrow.gif'></td>");
...
ArticleToolbar.prototype.addBold = function(){
	...
	this.Html.push("<img src='../../ewcmssource/image/article/toolbar/spacer.gif' style='background-position: 0px -304px; background-image: url(../../ewcmssource/image/article/toolbar/fck_strip.gif);overflow: hidden;width: 14px;height: 14px;margin: 1px;'>");
	this.Html.push("</div></td>");
}
...
ArticleToolbar.prototype.addItalic = function(){
	...
	this.Html.push("<img src='../../ewcmssource/image/article/toolbar/spacer.gif' style='background-position: 0px -320px; background-image: url(../../ewcmssource/image/article/toolbar/fck_strip.gif);overflow: hidden;width: 14px;height: 14px;margin: 1px;'>");
	this.Html.push("</div></td>");
}
...
ArticleToolbar.prototype.addUnderLine = function(){
	...
	this.Html.push("<img src='../../ewcmssource/image/article/toolbar/spacer.gif' style='background-position: 0px -336px; background-image: url(../../ewcmssource/image/article/toolbar/fck_strip.gif);overflow: hidden;width: 14px;height: 14px;margin: 1px;'>");
	this.Html.push("</div></td>");
}
