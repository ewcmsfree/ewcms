			...
			<table class="formtable" align="center">
				...
				<tr>
					...
					<td class="formFieldError" width="80%">
						<s:textfield name="siteVo.serverDir" cssClass="inputtext"  size="40"/>
						<ul class="errorMessage"><li><span style="color:gray;">比如：e:/tomcat/webapps</span></li></ul>
						<s:fielderror ><s:param value="%{'siteVo.serverDir'}" /></s:fielderror>
					</td>				
				</tr>
				<tr>
					<td>资源发布目录：</td>
