...
<html>
	<head>
		...
		$(function(){
			...
			ewcmsBOBJ.setQueryURL('<s:url namespace="/ds/bean" action="query"/>');
			...
			ewcmsOOBJ.setInputURL('<s:url namespace="/ds/bean" action="input"/>');
			ewcmsOOBJ.setDeleteURL('<s:url namespace="/ds/bean" action="delete"/>');
		});
		</script>		
	</head>
