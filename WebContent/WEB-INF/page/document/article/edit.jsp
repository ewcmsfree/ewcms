								...
								<table width="100%">
									<tr>
										<td width="100%" style="border: 0px solid;">
											...
											<a href="javascript:void(0);" class="ewcmsBtn" tabindex="-1" id="" onclick="submitReview('<s:url action='submitReview' namespace='/document/article'><s:param name='articleRmcId' value='articleRmcId'></s:param></s:url>');return false;"><img src="<s:url value='/source/image/article/prerelease.gif'/>" width="20" height="20"/><b>预发布&nbsp;</b></a>
