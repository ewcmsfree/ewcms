								...
								<table width="100%">
									<tr>
										<td width="100%" style="border: 0px solid;">
											...
											<a href="javascript:void(0);" class="ewcmsBtn" tabindex="-1" id="" onclick="selectRelated('<s:url action='relation' namespace='/document/relation'><s:param name='articleId' value='articleVo.id'></s:param></s:url>');return false;"><img src="<s:url value='/source/image/article/relation.gif'/>" width="20" height="20" /><b>相关文章&nbsp;</b></a>
