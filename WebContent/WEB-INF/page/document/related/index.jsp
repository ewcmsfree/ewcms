		...
		<script>
			$(function(){
				...
				setGlobaVariable({
					...
					queryURL:'<s:url namespace="/document/related" action="query"><s:param name="articleRmcId" value="articleRmcId"></s:param></s:url>',
			...
			function upOperate(){
				...
				$.post('<s:url namespace="/document/related" action="up"/>', {'articleRmcId':$("#articleRmcId").val(),'selectIds':rows[0].id}, function(data){
					if (data == "false"){
			...
			function downOperate(){
				...
				$.post('<s:url namespace="/document/related" action="down"/>', {'articleRmcId':$("#articleRmcId").val(),'selectIds':rows[0].id}, function(data){
					if (data == "false"){
