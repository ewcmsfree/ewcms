...
<html>
	<head>
		...
		$(function(){
			//基本变量初始
			setGlobaVariable({
				inputURL:'<s:url namespace="/document/citizen" action="input"/>',
				queryURL:'<s:url namespace="/document/citizen" action="query"/>',
				deleteURL:'<s:url namespace="/document/citizen" action="delete"/>',
				defaultWidth:300
			});
			//数据表格定义 						
			openDataGrid({
