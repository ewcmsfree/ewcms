		...
		<script type="text/javascript">
			$(function() {
				...
				$('#tt').datagrid({
					...
					striped : true,
					rownumbers : true,
					url : '<s:url namespace="/plugin/visit" action="entranceTable"/>?startDate=' + $('#startDate').val() + '&endDate=' + $('#endDate').val() + '&rows=' + $('#rows').val(),
				    columns:[[  
	...
	<body class="easyui-layout">
		<div region="north" style="height:40px">
			<table width="100%" border="0" cellspacing="6" cellpadding="0"style="border-collapse: separate; border-spacing: 6px;">
				<tr>
					<td>
						当前报表：入口分析&nbsp;&nbsp;&nbsp;&nbsp;从 <ewcms:datepicker id="startDate" name="startDate" option="inputsimple" format="yyyy-MM-dd"/> 至 <ewcms:datepicker id="endDate" name="endDate" option="inputsimple" format="yyyy-MM-dd"/> 显示行数 <s:textfield name="rows" id="rows"/> <a class="easyui-linkbutton" href="javascript:void(0)" onclick="view();return false;">查看</a>	<a class="easyui-linkbutton" href="javascript:void(0)" onclick="refresh();return false;">刷新</a>
					</td>
				</tr>
			</table>
		</div>
