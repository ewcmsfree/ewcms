		...
		<script type="text/javascript">
			...
			$(function() {
				...
				$('#tt').datagrid({
					...
					nowrap : true,
					striped : true,
					url : '<s:url namespace="/plugin/visit" action="stickTimeTable"/>?startDate=' + $('#startDate').val() + '&endDate=' + $('#endDate').val(),
				    columns:[[  
				            {field:'date',title:'日期',width:200},  
				            {field:'stSum',title:'会话停留时间',width:150},  
				            {field:'stAvg',title:'页均停留时间',width:150}
				    ]]  
				});
			});
			function showChart(){
