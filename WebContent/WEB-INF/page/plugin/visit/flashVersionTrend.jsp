...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function showChart(){
				...
				parameter['fieldValue'] = $('#fieldValue').val();
				parameter['labelCount'] = 8;
				$.post('<s:url namespace="/plugin/visit" action="flashVersionTrendReport"/>', parameter, function(result) {
	...
	<body class="easyui-layout">
		 <s:hidden id="fieldValue" name="fieldValue"/>
