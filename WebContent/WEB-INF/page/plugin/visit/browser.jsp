		...
		<script type="text/javascript">
			...
			$(function() {
				...
				$('#tt').datagrid({
					...
					nowrap : true,
					striped : true,
					url : '<s:url namespace="/plugin/visit" action="browserTable"/>?startDate=' + $('#startDate').val() + '&endDate=' + $('#endDate').val(),
				    columns:[[  
			...
			function showChart(){
				...
				$.post('<s:url namespace="/plugin/visit" action="browserReport"/>', parameter, function(result) {
			...
			function openTrend(value){
				...
				var url = '<s:url namespace="/plugin/visit" action="browserTrend"/>?startDate=' + $('#startDate').val() + '&endDate=' + $('#endDate').val() + '&fieldValue=' + value;
