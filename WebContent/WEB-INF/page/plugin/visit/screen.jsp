		...
		<script type="text/javascript">
			...
			$(function() {
				...
				$('#tt').datagrid({
					...
					nowrap : true,
					striped : true,
					url : '<s:url namespace="/plugin/visit" action="screenTable"/>?startDate=' + $('#startDate').val() + '&endDate=' + $('#endDate').val(),
				    columns:[[  
			...
			function showChart(){
				...
				$.post('<s:url namespace="/plugin/visit" action="screenReport"/>', parameter, function(result) {
			...
			function openTrend(value){
				...
				var url = '<s:url namespace="/plugin/visit" action="screenTrend"/>?startDate=' + $('#startDate').val() + '&endDate=' + $('#endDate').val() + '&fieldValue=' + value;
