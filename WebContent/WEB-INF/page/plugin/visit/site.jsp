		...
		<script type="text/javascript">
			...
			$(function() {
				...
				$('#tt').datagrid({
					...
					nowrap : true,
					striped : true,
					url : '<s:url namespace="/plugin/visit" action="siteTable"/>?startDate=' + $('#startDate').val() + '&endDate=' + $('#endDate').val(),
				    columns:[[  
				            {field:'name',title:'名称',width:200},  
				            {field:'pv',title:'PV数量',width:150},  
				            {field:'uv',title:'UV数量',width:150},
				            {field:'ip',title:'IP数量',width:150},
				            {field:'rv',title:'回头客人数',width:150}
				    ]]  
				});
			});
			function showChart(){
				...
				$.post('<s:url namespace="/plugin/visit" action="siteReport"/>', parameter, function(result) {
	...
	<body class="easyui-layout">
		 <div region="north" style="height:310px">
			<table width="100%" border="0" cellspacing="6" cellpadding="0"style="border-collapse: separate; border-spacing: 6px;">
				<tr>
					<td>
						当前报表：全站点击量&nbsp;&nbsp;&nbsp;&nbsp;从 <ewcms:datepicker id="startDate" name="startDate" option="inputsimple" format="yyyy-MM-dd"/> 至 <ewcms:datepicker id="endDate" name="endDate" option="inputsimple" format="yyyy-MM-dd"/> <a class="easyui-linkbutton" href="javascript:void(0)" onclick="refresh();return false;">查看</a>
					</td>
				</tr>
				<tr valign="top">
					<td>
