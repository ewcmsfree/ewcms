...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="tipMessage();">
		<s:form id="articleSave" action="save" namespace="/document/article">
								...
								<table width="100%">
									<tr>
										<td width="100%" style="border: 0px solid;">
											<a href="javascript:void(0);" class="ewcmsBtn" tabindex="-1" id="" onclick="createArticle('<s:url action='input' namespace='/plugin/article'/>?workingBodyId=' + $('#workingBodyId').val() + '&channelId=' + $('#channelId').val());return false;"><img src="<s:url value='/source/image/article/icon003a2.gif'/>" width="20" height="20" /><b>新建&nbsp;</b></a>
											<a href="javascript:void(0);" class="ewcmsBtn" tabindex="-1" id="" onclick="saveArticle();return false;"><img src="<s:url value='/source/image/article/icon003a16.gif'/>" width="20" height="20"/><b>保存</b></a>
											...
											<a href="javascript:void(0);" class="ewcmsBtn" tabindex="-1" id="" onclick="preRelease('<s:url namespace='/plugin/article' action='prerelease'/>?articleRmcId=' + $('#articleRmcId').val() + '&channelId=' + $('#channelId').val());return false;"><img src="<s:url value='/source/image/article/icon003a6.gif'/>" width="20" height="20"/><b>预发布</b></a>
											<a href="javascript:void(0);" class="ewcmsBtn" tabindex="-1" id="" onclick="getKeywordOrSummary('keyWord','<s:url action="keyword" escapeAmp="false"/>');return false;"><img src="<s:url value='/source/image/article/icon029a17.gif'/>" width="20" height="20" /><b>提取关键字&nbsp;</b></a>
											<a href="javascript:void(0);" class="ewcmsBtn" tabindex="-1" id="" onclick="getKeywordOrSummary('summary','<s:url action="summary" escapeAmp="false"/>');return false;"><img src="<s:url value='/source/image/article/icon029a28.gif'/>" width="20" height="20" /><b>提取摘要&nbsp;</b></a>
											<a href="javascript:void(0);" class="ewcmsBtn" tabindex="-1" id="" onclick="selectHistory('<s:url action='selectId' namespace='/document/history'><s:param name='articleId' value='articleVo.id'></s:param></s:url>');return false;"><img src="<s:url value='/source/image/article/icon_column.gif'/>" width="20" height="20" /><b>历史内容&nbsp;</b></a>
											<a href="javascript:void(0);" class="ewcmsBtn" tabindex="-1" id="" onclick="selectRelated('<s:url action='related' namespace='/document/related'><s:param name='articleRmcId' value='articleRmcId'></s:param></s:url>');return false;"><img src="<s:url value='/source/image/article/icon003a17.gif'/>" width="20" height="20" /><b>相关文章&nbsp;</b></a>
											<a href="javascript:void(0);" class="ewcmsBtn" tabindex="-1" id="" onclick="selectRecommend('<s:url action='recommend' namespace='/document/recommend'><s:param name='articleRmcId' value='articleRmcId'></s:param></s:url>');return false;"><img src="<s:url value='/source/image/article/icon003a10.gif'/>" width="20" height="20" /><b>推荐文章&nbsp;</b></a>
											...
											<a href="javascript:void(0);" class="ewcmsBtn" tabindex="-1" id="" onclick="ewcmsCookies();return false;" ><img id="imgCookies" src="<s:url value='/source/image/article/cookies.gif'/>" width="20" height="20" /><b><s:label id="cookiesLabel" value="设置常用项"></s:label>&nbsp;</b></a>
				...
				<table id="inputBarTable" width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#F6F9FD" style="border: #B7D8ED 1px solid;" class="formtable" >
			        ...
			        <tr id="trShowHide_1" style="display:none">
			        	...
			        	<td width="44%">
			        		...
			        		<s:textfield name="articleVo.eauthor" size="30"></s:textfield>&nbsp;&nbsp;
			        	</td>
			...
			<s:hidden id="workingBodyId" name="workingBodyId"/>
