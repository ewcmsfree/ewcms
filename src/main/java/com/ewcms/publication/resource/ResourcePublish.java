...
public class ResourcePublish implements ResourcePublishable{
    ...
    @Override
    public void publishAgain(Integer id, Boolean templateSource)
...
////        }
////        //DeployOperatorFactory.factory(server.getOutputType()).copy(server, outputResources);
////    }
////   
//    /**
//     * 创建输出资源对象
...
//            SiteServer server = site.getSiteServer();
//            //DeployOperatorFactory.factory(server.getOutputType()).copy(server, Arrays.asList(createOutputResource(resource)));
//        }
//    }
//    
