 ...
 * @author wangwei
 */
public class DefaultDetailUriRule extends UriRule{
    
    private static final Logger logger = LoggerFactory.getLogger(DefaultDetailUriRule.class);
    
    public DefaultDetailUriRule(){
