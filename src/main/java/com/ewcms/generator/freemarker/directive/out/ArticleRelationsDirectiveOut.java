 ...
 * @author wangwei
 */
public class ArticleRelationsDirectiveOut implements DirectiveOutable {
    private static final Logger logger = LoggerFactory.getLogger(ArticleRelationsDirectiveOut.class);
