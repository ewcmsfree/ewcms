...
package com.ewcms.plugin.notes.model;
 ...
 */
@Entity
@Table(name = "plugin_notes_memoranda")
@SequenceGenerator(name = "seq_plugin_notes_memoranda", sequenceName = "seq_plugin_notes_memoranda_id", allocationSize = 1)
public class Memoranda implements Serializable {
	...
	@Id
    @GeneratedValue(generator = "seq_plugin_notes_memoranda",strategy = GenerationType.SEQUENCE)
	@Column(name = "id")
	private Long id;
