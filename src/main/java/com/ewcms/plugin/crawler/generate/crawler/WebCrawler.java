...
import com.ewcms.plugin.crawler.generate.fetcher.CustomFetchStatus;
...
public class WebCrawler implements Runnable {
	...
	protected static final Logger logger = LoggerFactory.getLogger(WebCrawler.class.getName());
