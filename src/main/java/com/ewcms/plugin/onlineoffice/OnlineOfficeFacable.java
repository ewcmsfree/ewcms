 ...
 * http://www.jict.org
 */
package com.ewcms.plugin.onlineoffice;
 ...
 * @author 吴智俊
 */
public interface OnlineOfficeFacable {
	/**
	 * 新增在线办事主体信息
	 * 
	 * @param parentId
	 ...
	 * @return 文章主体编号
	 */
	public Integer addArticleRmcToWorkingBody(Article article,
	 ...
	 * @return 文章主体编号
	 */
	public Integer updArticleRmcToWorkingBody(Integer articleRmcId,
	...
	public void delArticleRmcToWorkingBody(Integer workingBodyId,
			Integer articleRmcId, Integer channelId);
