...
package com.ewcms.content.document.util.analyzer.seg;

import java.util.LinkedList;
import java.util.List;

import com.ewcms.content.document.util.analyzer.Context;
import com.ewcms.content.document.util.analyzer.Lexeme;
import com.ewcms.content.document.util.analyzer.dic.Dictionary;
import com.ewcms.content.document.util.analyzer.dic.Hit;
import com.ewcms.content.document.util.analyzer.help.CharacterHelper;

/**
 * <ul>
 * 中文（CJK）词元处理子分词器，涵盖一下范围：<br/>
 * 1.中文词语<br/>
 * 2.姓名<br/>
 * 3.地名<br/>
 * 4.未知词（单字切分）<br/>
