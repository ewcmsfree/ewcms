...
public class RecycleBinQueryAction extends QueryBaseAction {
    ...
    protected Resultable querySelectionsResult(QueryFactory queryFactory, int rows, int page, String[] selections, Order order) {
		...
		hql += " Order By Case When o.top Is Null Then 1 Else 0 End, o.top Desc, o.sort Asc, Case When r.published Is Null Then 0 Else 1 End, r.published Desc, Case When r.modified Is Null Then 0 Else 1 End, r.modified Desc, o.id";
