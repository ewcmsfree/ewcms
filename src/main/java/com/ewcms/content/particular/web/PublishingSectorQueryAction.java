...
public class PublishingSectorQueryAction extends QueryBaseAction{
	...
	protected Resultable queryResult(QueryFactory queryFactory,
    	...
    	EntityQueryable query = queryFactory.createEntityQuery(PublishingSector.class).setPage(page).setRow(rows).orderAsc("id");
