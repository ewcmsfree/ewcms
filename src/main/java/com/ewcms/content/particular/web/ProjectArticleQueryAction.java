...
public class ProjectArticleQueryAction extends QueryBaseAction{
	...
	protected Resultable queryResult(QueryFactory queryFactory,
    	...
    	EntityQueryable query = queryFactory.createEntityQuery(ProjectArticle.class).setPage(page).setRow(rows).orderDesc("id");
